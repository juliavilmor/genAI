...
# weights_files = ['../weights/weights_dm256_nh4_ff1024_nl20_sched.pth',\
#                 '../weights/weights_dm512_nh8_ff4096_nl4_sched.pth', \
#                 '../weights/weights_dm768_nh12_ff4608_nl2_sched.pth']

# weights_files = ['../weights/weights_dm256_nh4_ff1024_nl6_downs100_autoreg_epoch_32.pth',\
#                 '../weights/weights_dm256_nh4_ff1024_nl6_downs75_autoreg_epoch_32.pth', \
#                 '../weights/weights_dm256_nh4_ff1024_nl6_downs50_autoreg_epoch_26.pth',\
#                 '../weights/weights_dm256_nh4_ff1024_nl6_downs40_autoreg_epoch_23.pth',\
#                 '../weights/weights_dm256_nh4_ff1024_nl6_downs25_autoreg_epoch_32.pth']

weights_files = ['../weights/weights_dm256_nh4_ff1024_nl6_downs50_new_epoch_32.pth']

results = []

for i, weight in enumerate(weights_files):
# for i in range(1, 12):
#     weight = f'../weights/weights_dm768_nh12_ff4608_nl2_tok_epoch_{i}.pth'
#     print(i, weight)
...
df_results.to_csv('test_generation_new_dataset/results_success_rate_dm256_nh4_ff1024_nl6.csv', index=False)